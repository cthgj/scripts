	  ...
	  c2:for(my $k=$n+1; $k<=$#cls;$k++){
		...
		my $prec1=&term_precision($class1_annotation);
		  ...
		  if($check_both){
		      ...
		      if($Pa<=$prob || $Pi<=$prob){
			  print STDERR "FOUND $bait,$class1_annotation,$class2_annotation : $Pa : $Pi\n" if $bait eq 'SC24C_HUMAN';
			  my $a=$cls[$n] . "_" . $cls[$k];
...
#				    next bait;
			  ...
			  print STDERR "SKIPPED $bait,$cls[$n],$class1_annotation,$cls[$k],$class2_annotation : $Pa : $Pi\n" if $bait eq 'SC24C_HUMAN';
		  ...
		  ## If we are NOT checking BOTH inter and annot probs
		      ...
		      if($P<=$prob){
			  print STDERR "FOUND $bait,$class1_annotation,$class2_annotation : $P\n" if $bait eq 'SC24C_HUMAN';
			  my $a=$cls[$n] . "_" . $cls[$k];
...
#				    next bait;
			  ...
			  print STDERR "SKIPPED $bait,$cls[$n],$class1_annotation,$cls[$k],$class2_annotation : $P\n" if $bait eq 'SC24C_HUMAN';
